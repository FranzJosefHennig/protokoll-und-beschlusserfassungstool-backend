...
public class AbteilungsleiterController {
    ...
    @PostMapping("/protokoll/lehrer/create")
    ...
    @GetMapping("/protokoll/lehrer/{id}")
    ...
    @PutMapping("/protokoll/lehrer/update/{id}")
    ...
    @DeleteMapping("protokoll/lehrer/delete/{id}")
    ...
    @GetMapping("protokoll/lehrer/findbyword/{word}")
